...
AIM: To study and perform natural sampling of an analog signal using a pulse train and analyze the sampled waveform.

TOOLS REQUIRED: Software: Google Colab Python Libraries: Numpy,Matplotlib
